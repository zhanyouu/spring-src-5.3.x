...
----
	@RequestMapping("/")
	public String handle(@SessionAttribute entity user) { <1>
		// ...
	}
----
...
----
	@RequestMapping("/")
	fun handle(@SessionAttribute user: entity): String { // <1>
		// ...
	}
----
...
----
	...
	public class UserController {
		...
		@GetMapping("/user")
		@JsonView(entity.WithoutPasswordView.class)
		public entity getUser() {
			return new entity("eric", "7!jd#h23");
		}
	}
...
----
	...
	class UserController {
		...
		@GetMapping("/user")
		@JsonView(entity.WithoutPasswordView::class)
		fun getUser() = entity("eric", "7!jd#h23")
	}
...
----
	...
	public class UserController {
		...
		public MappingJacksonValue getUser() {
			entity user = new entity("eric", "7!jd#h23");
			MappingJacksonValue value = new MappingJacksonValue(user);
			value.setSerializationView(entity.WithoutPasswordView.class);
			return value;
		}
	}
----
...
----
	...
	class UserController {
		...
		fun getUser(): MappingJacksonValue {
			val value = MappingJacksonValue(entity("eric", "7!jd#h23"))
			value.serializationView = entity.WithoutPasswordView::class.java
			return value
		}
	}
----
...
----
	...
	public class UserController extends AbstractController {
		...
		public String getUser(Model model) {
			model.addAttribute("user", new entity("eric", "7!jd#h23"));
			model.addAttribute(JsonView.class.getName(), entity.WithoutPasswordView.class);
			return "userView";
		}
	}
----
...
----
	...
	class UserController : AbstractController() {
		...
		fun getUser(model: Model): String {
			model["user"] = entity("eric", "7!jd#h23")
			model[JsonView::class.qualifiedName] = entity.WithoutPasswordView::class.java
			return "userView"
		}
	}
----
